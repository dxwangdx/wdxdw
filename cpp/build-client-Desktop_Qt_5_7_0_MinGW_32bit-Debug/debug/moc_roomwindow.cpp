...
QT_MOC_LITERAL(3, 32, 19), // "on_btn_room_clicked"
QT_MOC_LITERAL(4, 52, 22), // "on_btn_refresh_clicked"
QT_MOC_LITERAL(5, 75, 24), // "on_lw_room_doubleClicked"
QT_MOC_LITERAL(6, 100, 5) // "index"

    },
    "RoomWindow\0on_btn_exit_clicked\0\0"
    "on_btn_room_clicked\0on_btn_refresh_clicked\0"
    "on_lw_room_doubleClicked\0index"
};
...
void RoomWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->on_btn_room_clicked(); break;
        case 2: _t->on_btn_refresh_clicked(); break;
        case 3: _t->on_lw_room_doubleClicked((*reinterpret_cast< const QModelIndex(*)>(_a[1]))); break;
        default: ;
        }
    }
}
...
const QMetaObject RoomWindow::staticMetaObject = {
    { &QMainWindow::staticMetaObject, qt_meta_stringdata_RoomWindow.data,
      qt_meta_data_RoomWindow,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
