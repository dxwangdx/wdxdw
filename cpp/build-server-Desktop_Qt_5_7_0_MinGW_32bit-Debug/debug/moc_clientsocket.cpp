...
QT_MOC_LITERAL(1, 13, 8), // "sigWrite"
...
QT_MOC_LITERAL(7, 58, 3), // "len"
QT_MOC_LITERAL(8, 62, 11) // "onReadyRead"

    },
    "ClientSocket\0sigWrite\0\0QTcpSocket*\0"
    "socket\0const char*\0str\0len\0onReadyRead"
};
...
void ClientSocket::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->sigWrite((*reinterpret_cast< QTcpSocket*(*)>(_a[1])),(*reinterpret_cast< const char*(*)>(_a[2])),(*reinterpret_cast< int(*)>(_a[3]))); break;
        ...
        {
            typedef void (ClientSocket::*_t)(QTcpSocket * , const char * , int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&ClientSocket::sigWrite)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void ClientSocket::sigWrite(QTcpSocket * _t1, const char * _t2, int _t3)
{
